...
predictCRM2 <- function(data,
  ...
  data$SND_WOOD_DECAY <- ifelse(data$CULL < 99,
                                (1 - data$CULL / 100),
                                0)
  ...
  # otherwise missing
  data[data$SFTWD_HRDWD == 'S' & data$DBH <  9.0 & !is.na(data$DBH),
       c("VSAWIB_GROSS", "VSAWOB_GROSS", "VSAWBK_GROSS",
         "VSAWIB_PRESENT", "VSAWOB_PRESENT", "VSAWBK_PRESENT",
         "VSAWIB_SOUND", "VSAWOB_SOUND", "VSAWBK_SOUND")] <- NA
  data[data$SFTWD_HRDWD == 'H' & data$DBH < 11.0 & !is.na(data$DBH),
       c("VSAWIB_GROSS", "VSAWOB_GROSS", "VSAWBK_GROSS",
         "VSAWIB_PRESENT", "VSAWOB_PRESENT", "VSAWBK_PRESENT",
         "VSAWIB_SOUND", "VSAWOB_SOUND", "VSAWBK_SOUND")] <- NA
  ...
  data$broken_crn_prop <- ifelse(data$broken_crn_prop < 0.01, 0, data$broken_crn_prop)
  ...
  data[data$DBH < 5, c("VMERBK_GROSS", "VMERBK_SOUND",
                       "VMERIB_GROSS", "VMERIB_SOUND",
                       "VSAWBK_GROSS", "VSAWBK_SOUND",
                       "VSAWIB_GROSS", "VSAWIB_SOUND",
                       "VSTPBK_GROSS", "VSTPBK_SOUND",
                       "VSTPIB_GROSS", "VSTPIB_SOUND",
                       "VTOPBK_GROSS", "VTOPBK_SOUND",
                       "VTOPIB_GROSS", "VTOPIB_SOUND",
